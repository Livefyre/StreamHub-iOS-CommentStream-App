    ...
    if (numberOfLikes > 0u) {
        if ([self.contentItem.likes containsObject:kCurrentUserId]) {
            ...
            [likeButton setTitle:[NSString stringWithFormat:@"%lu", (unsigned long)numberOfLikes]
                        forState:UIControlStateNormal];
            [likeButton setTitleColor:[UIColor colorForToolbarButtonStateNormal]
                             forState:UIControlStateNormal];
            [likeButton setTitleColor:[UIColor colorForToolbarButtonStateHighlighted]
            ...
            [likeButton setTitle:[NSString stringWithFormat:@"%lu", (unsigned long)numberOfLikes]
                        forState:UIControlStateNormal];
            [likeButton setTitleColor:[UIColor colorForToolbarButtonNormal]
                             forState:UIControlStateNormal];
            [likeButton setTitleColor:[UIColor colorForToolbarButtonHighlighted]
                             forState:UIControlStateHighlighted];
        }
    }
    else {
...
- (void)didSelectButton2:(id)sender
{
    ...
    [self.postViewController setAvatarImage:
     [UIImage imageWithColor:[UIColor colorForImagePlaceholder]]];
